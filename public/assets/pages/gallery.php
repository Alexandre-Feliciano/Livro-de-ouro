...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/rough-notation/lib/rough-notation.iife.js"></script>
...
<body>
    ...
    <section>
        ...
        <div id="conteiner-principal">
            ...
            <p id="text-message"> Em quatro anos de caminhada juntos, a Turma 1814 aprendeu que, mesmo nas diferenças,
                existe algo que sempre nos uniu: a vontade de fazer acontecer. E quando a gente se une, não há nada que
                nos pare.
                Fizemos mais do que programar e resolver cálculos. A cada projeto, evento e apresentação, deixamos um
                pouco de nós ali. Fomos mais do que colegas de sala, fomos apoio, torcida, força e risada uns para os
                outros.
                <br>
                Quem estava no Fast Dance lembra da energia vibrando quando a turma se uniu para prestigiar os colegas
                no palco. Ou da emoção da peça "O Auto da Compadecida", quando todos se envolveram para fazer algo
                incrível acontecer. Teve também Peter Pan, A Alice no País das Maravilhas e O Alto da Barca do Inferno,
                nosso primeiro contato com o teatro, em que mergulhamos de cabeça.
                <br>
                Nosso bingo foi uma comédia à parte e um sucesso. E como esquecer da exposição de matemática, onde
                mostramos que criatividade e raciocínio também caminham juntos? Sem contar os momentos nas aulas de
                educação física, em que, mesmo cansados, torcíamos com todo coração por quem estava em quadra.
                <br>
                A nossa farda azul-marinho virou símbolo de quem somos: firmes, unidos e prontos para qualquer desafio.
                É com esse espírito o de uma turma que viveu intensamente, que brigou, riu, chorou e se superou que
                apresentamos este Livro de Ouro. Um espaço onde cada assinatura é um gesto de apoio, de reconhecimento,
                e de carinho por tudo que construímos até aqui.
                <br>
                <br>
                Com gratidão e orgulho,
                <br>
                Turma 1814 – Informática
            </p>
    ...
    <section id="section-secundary">
        ...
        <div id="conteiner-secundary">

            <h1 class="title-memoria" id="title-primary"></h1>
    ...
    <section id="section-3">
        ...
        <!-- A parte da nuvem das palavras, está com uma qualidade baixa devido tamanho-->
        <div id="conteiner-cloud">

            <h1 id="title-secundary">Todos os nossos apoiadores</h1>
    ...
    <section id="section-4">
        <h1 id="title-terciary">Recados</h1>
        <div id="conteiner-message">
            <div id="message-recado">
                <div class="swiper" id="recado-swiper">
